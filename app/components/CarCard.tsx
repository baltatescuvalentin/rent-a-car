                ...
                <div className="flex flex-col sm:flex-row justify-center gap-2 ">
                    <div className="flex items-center justify-center">
                        <div className="relative">
                            <Image onClick={() => router.push(`/models/${data?.id}`)} alt="car model" src={data?.imgSrc[0]} width={0} height={0} sizes="100vw" className="h-[210px] w-[350px] sm:h-[225px] md:w-[330px] hover:cursor-pointer" />
